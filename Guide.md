...
**Note:**: Some domain providers offer a service to hide this information from being public, and sometimes people obscure it on purpose for privacy reasons. 
...
Checking out the terrain of the claimed location through satellite imagery.

Below is one of thousands of photos leaked depicting violations of human rights in Syrian prisons. The leaked photo was geolocated through looking at the satellite image below, then the terrain which shows the hill that has the communication towers.  
...
You inherently leave many traces while you are browsing the internet to carry on your online investigation or any other thing. Most of the websites that you visit colelct information about you such as your location thrugh your IP address, Your browser fingerprint, the device you are using to access the internet (Mobile, tablet, computer), sometimes the uniqeue number for your device which is called the MAC address, the pages you visisted, how long you stayed one a speficic page, other websites you visited. All this collected information can create a rofile about you which makes you identifiable. It's important to make sure that you are browsing the internet securely and anonymousley if you don't want the hackers who are connected to the same WiFi network to see what you are doing, as well as hiding your identitfu from websites you are visiting, or your internet service provider.  
